...
/* USER CODE BEGIN 0 */
uint16_t adc_dmaBuffer[ADC_RAW_BUFFER_LENGTH];
uint16_t adc_workingBuffer[ADC_RAW_BUFFER_LENGTH];
uint32_t adc_avgBuffer[ADC_MAX_CHANNELS];
uint32_t g_adcBuffer[ADC_MAX_CHANNELS];
uint16_t g_adcDmaReadCounts = 0;
/* USER CODE END 0 */
